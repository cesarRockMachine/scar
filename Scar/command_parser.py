...
def create_init_parser(subparsers, init):
    ...
    parser_init.add_argument("image_id_or_path", help="Container image id (i.e. centos:7)")
...
def create_update_parser(subparsers, update):
    parser_update = subparsers.add_parser('update', help="Update function configuration.")
    parser_update.set_defaults(func=update)
    parser_update.add_argument("name", help="Lambda function name")
    ...
    parser_update.add_argument("-e", "--env", action='append', help="Pass environment variable to the container (VAR=val). Can be defined multiple times.")
